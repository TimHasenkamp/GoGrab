<script lang="ts">
  // Inline Lucide icons. Same SVG paths as lucide.dev (ISC license) so the
  // visual result matches the Lucide library exactly without pulling a
  // dependency. Add new icons here as needed; keep paths short and
...
>
  {#if name === 'eye'}
    <path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10 0-10-7Z" />
